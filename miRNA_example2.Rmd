...
ann = readRDS("/home/saheed/Desktop/Arizona_Courses/2024_2025/Fall_2024/Indep_Study_2024Fall/OC_miRNA/b1b4_ann_with_brca.rds") %>%
...
logit_model <- glmnet(X2, y2, 
                   family = binomial, alpha = 1)


# Predict on test data
predictions2 <- predict(logit_model, newx = as.matrix(test_df2), type = "response")
predictions2_train_df2 <- predict(logit_model, newx = X2, type = "response")
